...
{
    /// <summary>
    /// The camera component that manages the priority stack and blending between all
    /// active <see cref="ICinemachineCamera"/> connected to it.  Its responsibilites are to
    /// choose the current virtual camera, blend with another if necessary, and apply
    /// the virtual camera output to the Unity Camera attached to this game object.
    /// </summary>
    ...
    public class CinemachineBrain : MonoBehaviour
    {
        ...
        /// </summary>
        [Tooltip("When enabled, shows the camera's frustum in the scene view")]
        ...
        /// </summary>
        [Tooltip("If set, this object's Y axis will define the worldspace Up vector for all the virtual cameras.  This is useful in top-down game environments.  If not set, Up is worldspace Y.")]
        ...
        /// minimize the potential jitter.  Use FixedUpdate for RigidBody animation.
        /// SmartUpdate will choose the best method for each virtual camera, depending
        /// on how the target is animated.</summary>
        [Tooltip("Depending on how the target objects are animated, adjust the update method to minimize the potential jitter.  Use FixedUpdate for RigidBody animation.")]
        ...
        /// </summary>
        [HideInInspector]
        [Tooltip("This is the asset which contains custom settings for specific blends")]
        ...
        /// Cinemachine provides an optional package wuith this implementation.
        /// </summary>
        ...
        /// <summary>
        /// Camera cut event.  This will fire whenever there is a zero-length blend
        /// between virtual cameras.
        /// </summary>
        public UnityEvent m_CameraCutEvent;

        /// <summary>
        /// Camera activated event.  This will fire whenever a virtual camera goes live.
        /// </summary>
        ...
        /// call <see cref="ReleaseCameraOverride"/> after all overriding is finished, to
        ...
        /// <returns>The oiverride ID.  Don't forget to call <see cref="ReleaseCameraOverride"/>
        ...
        /// See <see cref="SetCameraOverride"/>.
        /// </summary>
        /// <param name="overrideId">The ID to released.  This is the value that
        /// was returned bu <see cref="SetCameraOverride"/></param>
        ...
        private void OnGUI()
        {
            if (CoreDebuggerUICallback != null)
                CoreDebuggerUICallback();
        ...
        /// <summary>Obsolete Debugging API.  To be removed.</summary>
        public static Action CoreDebuggerUICallback = null;
        /// <summary>Obsolete Debugging API.  To be removed.</summary>
        public static Action CoreDebuggerPostFrameUpdateCallback = null;

        /// <summary>
        /// True if this brain is suspended.  If so, scene <see cref="Camera"/> is not updated,
        ...
        /// <summary>
        /// True if the <see cref="ICinemachineCamera"/> the current active camera,
        ...
        /// <summary>
        /// Get the highest-priority Enabled <see cref="ICinemachineCamera"/>
        ...
        /// <summary>
        /// Create a blend curve for blending from one <see cref="ICinemachineCamera"/> to another.
    ...
    /// a <see cref="CameraState"/> and exposes it as a virtual camera for the purposes of blending.
    /// </summary>
    ...
    /// <summary>
    /// Blend result source for blending.   This exposes a <see cref="CinemachineBlend"/> object
