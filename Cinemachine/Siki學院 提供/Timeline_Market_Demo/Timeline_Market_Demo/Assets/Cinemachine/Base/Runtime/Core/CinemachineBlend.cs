...
{
    /// <summary>
    /// Describes a blend between 2 <see cref="ICinemachineCamera"/>, and holds the
    ...
    public class CinemachineBlend
    {
        ...
        /// and there is a notrivial blend curve.</summary>
        public bool IsValid
        {
            get
            {
        ...
        /// <summary>Make sure the source cameras get updfated.</summary>
        ...
        /// <summary>Compute the blended <see cref="CameraState"/> for the current time in the blend.</summary>
        public CameraState State { get { return CameraState.Lerp(CamA.State, CamB.State, BlendWeight); } }
    }

    /// <summary>Definition of a CameraState blend.  This struct holds the information
    /// necessary to generate a suitable AnimationCurve for a <see cref="CinemachineBlend"/>.</summary>
    [Serializable]
    public struct CinemachineBlendDefinition
    {
        /// <summary>Supported predifined shapes for the blend curve.</summary>
        public enum Style
        {
            /// <summary>Zero-length blend</summary>
            Cut,
            /// <summary>S-shaped curve, giving a gentle ansd smooth transition</summary>
            EaseInOut,
        ...
        /// <summary>
        /// <see cref="AnimationCurve"/> specifying the interpolation duration and value
