...
namespace Cinemachine
{
    ...
    public class CinemachineOrbitalTransposer : MonoBehaviour, ICinemachineComponent
    {
        ...
        /// <summary>How the damping values will be interpreted.
        /// Polar will attempt to preserve a constant distance from the target, subject
        /// to Z damping.</summary>
        ...
        public struct Recentering
        {
            ...
            [Tooltip("How 'forward' is defined.  The camera will be placed behind the target")]
