...
namespace Cinemachine
{
    ...
    public class CinemachineComposer : MonoBehaviour, ICinemachineComponent
    {
        ...
        [Tooltip("Target offset from the object's center in LOCAL space which the Composer tracks. Use this to fine-tune the tracking target position when the desired area is not in the tracked object's center.")]
        public Vector3 m_TrackedObjectOffset = Vector3.zero;

        /// <summary>How aggressively the camera tries to follow the target.
        ...
        [Space]
        [Range(0f, 100f)]
        [Tooltip("How aggressively the camera tries to follow the target. Small numbers are more responsive, rapidly orienting the camera to keep the target in the dead zone. Larger numbers give a more heavy slowly responding camera. Using different vertical and horizontal settings can yield a wide range of camera behaviors.")]
        public float m_HorizontalDamping = 0.5f;

        /// <summary>How aggressively the camera tries to follow the target. Small numbers are more
        /// responsive, rapidly orienting the camera to keep the target in the dead zone. Larger numbers
        /// give a more heavy slowly responding camera. Using different vertical and horizontal settings
        /// can yield a wide range of camera behaviors.</summary>
        [Range(0f, 100f)]
        [Tooltip("How aggressively the camera tries to follow the target. Small numbers are more responsive, rapidly orienting the camera to keep the target in the dead zone. Larger numbers give a more heavy slowly responding camera. Using different vertical and horizontal settings can yield a wide range of camera behaviors.")]
        public float m_VerticalDamping = 0.5f;

        /// <summary>Horizontal screen position for target. The camera will rotate to to position the tracked object here</summary>
        [Space]
        [Range(0f, 1f)]
        [Tooltip("Horizontal screen position for target. The camera will rotate to to position the tracked object here.")]
        ...
        [Range(0f, 1f)]
        [Tooltip("Vertical screen position for target, The camera will rotate to to position the tracked object here.")]
        ...
        [Range(0f, 2f)]
        [Tooltip("When target is within this region, camera will gradually move to re-align towards the desired position, depending onm the damping speed.")]
        ...
        /// <summary>Returns the Aim stage</summary>
