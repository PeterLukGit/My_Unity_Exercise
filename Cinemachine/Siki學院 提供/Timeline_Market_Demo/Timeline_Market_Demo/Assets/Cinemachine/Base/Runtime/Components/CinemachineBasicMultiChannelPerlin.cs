...
namespace Cinemachine
{
    ...
    /// channel of the <see cref="CameraState"/>.
    /// </summary>
    ...
    {
        /// <summary>
        /// Serialized property for referencing a <see cref="NoiseSettings"/> asset
        /// </summary>
        [HideInInspector]
        [Tooltip("The shared asset containing the module settings")]
        public NoiseSettings m_Definition;

        /// <summary>
        /// Gain to apply to the amplitudes defined in the settings asset.
        /// </summary>
        [Tooltip("Gain to apply to the amplitudes defined in the settings asset")]
        public float m_AmplitudeGain = 1f;

        /// <summary>
        /// Scale factor to apply to the frequencies defined in the settings asset.
        /// </summary>
        [Tooltip("Scale factor to apply to the frequencies defined in the settings asset")]
        ...
        /// <summary>Returns the Noise stage</summary>
        public ICinemachineCamera VirtualCamera
        { get { return gameObject.transform.parent.gameObject.GetComponent<ICinemachineCamera>(); } }

        /// <summary>Get the Cinemachine Pipeline stage that this component implements</summary>
