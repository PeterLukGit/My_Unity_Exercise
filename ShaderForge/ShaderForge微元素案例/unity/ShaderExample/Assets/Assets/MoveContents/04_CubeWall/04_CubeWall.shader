...
Shader "Move/04_CubeWall" {
    Properties {
        ...
        _DiffusePower ("DiffusePower", Range(0, 1)) = 0.0001
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
