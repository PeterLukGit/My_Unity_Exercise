...
////// Lighting:
                ...
                float node_5327 = ((1.0 - floor(saturate(((distance(i.uv0,0.5)*2.0)/_CircleSize))))*floor(((abs(atan2(node_2180.r,node_2180.g))/_pieSize)/3.141592654)));
