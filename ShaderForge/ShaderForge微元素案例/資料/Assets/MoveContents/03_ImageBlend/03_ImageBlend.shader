...
/*SF_DATA;ver:1.38;sub:START;pass:START;ps:flbk:,iptp:0,cusa:False,bamd:0,cgin:,lico:0,lgpr:1,limd:0,spmd:1,trmd:0,grmd:0,uamb:True,mssp:True,bkdf:False,hqlp:False,rprd:False,enco:False,rmgx:True,imps:True,rpth:0,vtps:0,hqsc:True,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:0,bsrc:0,bdst:1,dpts:2,wrdp:False,dith:0,atcv:False,rfrpo:True,rfrpn:Refraction,coma:15,ufog:True,aust:True,igpj:True,qofs:0,qpre:3,rntp:2,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,atwp:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:False,fnfb:False,fsmp:False;n:type:ShaderForge.SFN_Final,id:7202,x:33990,y:32637,varname:node_7202,prsc:2|emission-7549-OUT;n:type:ShaderForge.SFN_Vector1,id:5988,x:31972,y:32782,varname:node_5988,prsc:2,v1:0.5;n:type:ShaderForge.SFN_ScreenParameters,id:486,x:31972,y:32847,varname:node_486,prsc:2;n:type:ShaderForge.SFN_Divide,id:5281,x:32221,y:32707,varname:node_5281,prsc:2|A-5988-OUT,B-486-PXW;n:type:ShaderForge.SFN_Divide,id:7429,x:32221,y:32832,varname:node_7429,prsc:2|A-5988-OUT,B-486-PXH;n:type:ShaderForge.SFN_ScreenPos,id:4937,x:32423,y:32832,varname:node_4937,prsc:2,sctp:0;n:type:ShaderForge.SFN_RemapRange,id:5335,x:32612,y:32832,varname:node_5335,prsc:2,frmn:-1,frmx:1,tomn:0,tomx:1|IN-4937-UVOUT;n:type:ShaderForge.SFN_Add,id:9081,x:32806,y:32706,varname:node_9081,prsc:2|A-5935-OUT,B-5335-OUT;n:type:ShaderForge.SFN_Append,id:5935,x:32413,y:32707,varname:node_5935,prsc:2|A-5281-OUT,B-7429-OUT;n:type:ShaderForge.SFN_SceneColor,id:7283,x:32997,y:32706,varname:node_7283,prsc:2|UVIN-9081-OUT;n:type:ShaderForge.SFN_Tex2d,id:8923,x:33139,y:32534,ptovrint:False,ptlb:Primary,ptin:_Primary,varname:node_8923,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Tex2d,id:1470,x:33107,y:32914,ptovrint:False,ptlb:Secondary,ptin:_Secondary,varname:_Primary_copy,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Lerp,id:5751,x:33503,y:32546,varname:node_5751,prsc:2|A-8923-RGB,B-7283-RGB,T-4353-OUT;n:type:ShaderForge.SFN_OneMinus,id:4353,x:33320,y:32704,varname:node_4353,prsc:2|IN-8923-A;n:type:ShaderForge.SFN_OneMinus,id:2622,x:33302,y:33002,varname:node_2622,prsc:2|IN-1470-A;n:type:ShaderForge.SFN_Lerp,id:2141,x:33508,y:32911,varname:node_2141,prsc:2|A-1470-RGB,B-7283-RGB,T-2622-OUT;n:type:ShaderForge.SFN_Slider,id:699,x:33414,y:32802,ptovrint:False,ptlb:Range,ptin:_Range,varname:node_699,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0.4411611,max:1;n:type:ShaderForge.SFN_Lerp,id:7549,x:33785,y:32662,varname:node_7549,prsc:2|A-5751-OUT,B-2141-OUT,T-699-OUT;proporder:8923-1470-699;pass:END;sub:END;*/

Shader "Move/03_ImageBlend" {
    Properties {
        _Primary ("Primary", 2D) = "white" {}
        _Secondary ("Secondary", 2D) = "white" {}
        _Range ("Range", Range(0, 1)) = 0.4411611
    }
    SubShader {
        Tags {
