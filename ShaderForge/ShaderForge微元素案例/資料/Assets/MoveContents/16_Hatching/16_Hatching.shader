...
////// Lighting:
                ...
                float2 ScreenUV = ((float2((sceneUVs.x * 2 - 1)*(_ScreenParams.r/_ScreenParams.g), sceneUVs.y * 2 - 1).rg*0.5+0.5)*_HatchingTilling);
                ...
                float Light = ((0.5*dot(lightDirection,i.normalDir)+0.5*attenuation)*-2.0+1.0);
